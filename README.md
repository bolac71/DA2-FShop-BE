...
- **Quản lý kho**: Kho hàng real-time, lịch sử giao dịch hàng
...
- **Hệ thống gợi ý (Recommendations)**: Gợi ý sản phẩm cá nhân hóa dựa trên hành vi người dùng (Hybrid AI)
...
| **ai** | AI services (sentiment analysis, external interactions, etc.) |
| **recommendations** | Hệ thống gợi ý sản phẩm cá nhân hóa (Hybrid AI & Trending fallbacks) |
